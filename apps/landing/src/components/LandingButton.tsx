...
const buttonVariants = cva(
    ...
    ],
    {
        variants: {
            variant: {
                default: "bg-gradient-to-b from-blue-500 to-blue-700 outline outline-1 outline-offset-[-1px] outline-blue-600 blue-shadow",
                black: "bg-zinc-700 outline outline-1 outline-offset-[-1px] outline-zinc-700 black-shadow",
            }
        },
        defaultVariants: {
            variant: "default",
