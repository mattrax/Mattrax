					...
					<div class="flex-1 overflow-hidden flex">
						<ul class="rounded-lg space-y-4 overflow-y-auto flex-1">
							<For each={Object.entries(props.windowsCSPs)}>
								{([cspKey, value]) => (
									<li
										class="items-center gap-4 rounded-lg border-gray-300 border"
										style="contain:paint"
									>
										<div class="px-4 py-4 pb-2 sticky top-0 bg-white rounded-t-lg w-full truncate shadow border-t border-gray-300 -mt-px">
