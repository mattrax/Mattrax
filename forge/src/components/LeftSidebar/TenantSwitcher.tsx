    ...
    <div class="w-full relative inline-block text-left">
      ...
      <DialogRoot>
        <DropdownMenu controller={controller}>
          <DropdownMenuTrigger class="mt-1 inline-flex w-full justify-between rounded-md bg-brand-secondary text-white px-4 py-2 text-sm font-medium shadow-sm hover:bg-brand-tertiary focus:outline-none focus:ring-2 focus:ring-white">
