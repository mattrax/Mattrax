//! This is a dump of existing crypto code I wrote for Mattrax.
//! We should break this out into a reusable abstraction.
...
pub use cryptographic_message_syntax::{Oid, SignedData};
