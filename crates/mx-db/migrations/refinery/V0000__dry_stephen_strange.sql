...
ALTER TABLE `audit_log` ADD CONSTRAINT `audit_log_account_accounts_pk_fk` FOREIGN KEY (`account`) REFERENCES `accounts`(`pk`) ON DELETE no action ON UPDATE no action;
