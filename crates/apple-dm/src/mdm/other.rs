...
pub enum ManifestURLitemitemsItemassetassetsItemkind { 
    #[serde(rename = "asset-pack-manifest")]
	AssetPackManifest,
    #[serde(rename = "display-image")]
	DisplayImage,
    #[serde(rename = "full-size-image")]
	FullSizeImage,
}
...
pub struct ManifestURLitemitemsItemassetassetsItem {
    ...
    pub md_5_size: Option<i64>,
    #[serde(rename = "md5s")]
    #[serde(default, skip_serializing_if = "Option::is_none", deserialize_with = "deserialize_some", serialize_with = "serialize_some",)]
    pub md_5s: Option<Vec<String>>,
    #[serde(rename = "sha256-size")]
    #[serde(default, skip_serializing_if = "Option::is_none", deserialize_with = "deserialize_some", serialize_with = "serialize_some",)]
    pub sha_256_size: Option<i64>,
    #[serde(rename = "sha256s")]
    #[serde(default, skip_serializing_if = "Option::is_none", deserialize_with = "deserialize_some", serialize_with = "serialize_some",)]
    pub sha_25_6s: Option<Vec<String>>,
    pub url: String,
    #[serde(rename = "needs-shine")]
    #[serde(default, skip_serializing_if = "Option::is_none", deserialize_with = "deserialize_some", serialize_with = "serialize_some",)]
    pub needs_shine: Option<bool>,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub enum ManifestURLitemitemsItemmetadaumkind { 
	Software,
}
...
pub struct ManifestURLitemitemsItemmetadaum {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", deserialize_with = "deserialize_some", serialize_with = "serialize_some",)]
    pub bundle_version: Option<String>,
    pub kind: ManifestURLitemitemsItemmetadaumkind,
    ...
    pub title: String,
    #[serde(default, skip_serializing_if = "Option::is_none", deserialize_with = "deserialize_some", serialize_with = "serialize_some",)]
    pub items: Option<Vec<Option<ManifestURLitemitemsItemmetadaumitemmetadataItemsItem>>>,
}
...
pub struct EnrollmentSSODocument {
    ...
    pub configuration_profile: Vec<u8>,
}
...
pub struct PasswordHash {
    ...
    pub salted_sha512_pbkdf2: PasswordHashSALTEDSHA512PBKDF2,
}
